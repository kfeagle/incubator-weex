...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ea25fc20c32a1eb4c9caecf5cd6315ed', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ea25fc20c32a1eb4c9caecf5cd6315ed',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "value": function () {return 'fps:' + (this.fps)}
	      }
	    },
	    {
	      "type": "gcanvas",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hilo = __webpack_require__(6);
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        xxx: function xxx(img) {
	            ...
	            var fn = function fn() {
	                modal.toast({
	                    message: 'x: ' + (0, _stringify2.default)(ele.getRect()),
	                    duration: 8
	                });
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	Hilo.Image = Image;
	Hilo.CanvasElement = __webpack_require__(13);
	...
	function initImage() {
	    ...
	    Object.defineProperty(Image.prototype, 'src', {
	        ...
	        set: function (src) {
	            ...
	            this._src = src;
	            var self = this;
	            GBridge.preLoadImage(src, function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	CanvasElement.prototype.getContext = function(type) {
	    ...
	    gcanvas.start(this.ele.ref, function () {});
